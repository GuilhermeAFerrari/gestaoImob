        ...
        <table id="tabela" class="table">
            <thead>
                <tr style="text-align: center;
                    ...
                    <th scope="col">Descrição do recebimento</th>
            ...
            <?php foreach($recebimentos as $recebimento) : ?>
                    <tr style="text-align: center;">
                        <td>
                            <a href="<?php echo base_url('financeiro-recebimentos-editar/' . $recebimento->id_contaReceber) ?>">
                        ...
                        <td><?php echo $recebimento->nr_valorBruto ?></td>
                        <td><?php echo $recebimento->nr_juros ?></td>
                        <td><?php echo $recebimento->nr_desconto ?></td>

...
<div class="card" style="margin-top: 56px">
    <div class="card-header">
        <h5>Financeiro - Centro de custo</h5>
    </div>
        ...
        <table id="tabela" class="table">
            ...
            <tbody>
                <?php foreach($centros as $centro) : ?>
                    <tr style="text-align: center;">
                        <td>
                            <a href="<?php echo base_url('financeiro-confirmar-deletar-centro-custo/' . $centro->id_centroCusto) ?>">
                        ...
                        <td><?php echo $centro->ds_classe ?></td>
                        <td><?php echo $centro->ds_descricao ?></td>
                    </tr>
                <?php endforeach ?>
            </tbody>
        </table>

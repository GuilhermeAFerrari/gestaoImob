...
<div class="card" style="margin-top: 56px">
    <div class="card-header">
        <h5>Financeiro - Adicionar Recebimentos</h5>
    </div>
            ...
            <div class="row align-items-start">
                <div class="col-sm-12">
                    <div class="form-actions">
                        ...
                        <a href="<?php echo base_url('financeiro-recebimentos-listar') ?>" type="btn" class="btn btn-danger">Voltar</a>
                    </div>
                    <br/>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input size="150" class="form-control" name="ds_recebimento" type="text" value="<?php echo isset($contas) ? $contas->ds_recebimento : '' ?>">
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input size="50" class="form-control" name="dt_vencimento" required="" type="date" value="<?php echo isset($contas) ? $contas->dt_vencimento : '' ?>">  
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="custom-select mr-sm-2" name="ds_contaBancaria">  
                                <option value=""></option>
                                <?php foreach($contaBancaria as $conta) :?>
                                    <option value="<?php echo $conta->nr_agencia . '-' . $conta->nr_conta ?>"><?php echo $conta->nr_agencia . '-' . $conta->nr_conta ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-sm-2">
                    <div class="control-group">
                        <label class="control-label">Recebimento quitado</label>
                        <div class="controls">

                    ...
                    <div class="row align-items-start">
                        <div class="col-sm-12">
                          <div class="form actions">
                            <a href="<?php echo base_url('financeiro-deletar-pagamentos/' . $id_contaPagar) ?>" type="button" class="btn btn-danger" style="margin-left:20px; margin-bottom:10px;">Excluir</a>
